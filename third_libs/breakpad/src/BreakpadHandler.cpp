...
#endif
{
    ...
    */
    ...
    if(breakpad_static_p != nullptr) {
        ...
        // todo: dump_dir and minidump_id for linux
        printf("Dump path: %s\n", descriptor.path());
        QString dump_dir = QString::fromUtf8(descriptor.directory().c_str());
        QString minidump_id = ""; //descriptor.getMicrodumpDescriptor().
