...
public:
    NCRDTextPropDialog(NCReportItem *item, NCRDDocument* parent = 0 );
    ~NCRDTextPropDialog();
...
protected slots:
  /*$PROTECTED_SLOTS$*/
    ...
    void selectFile();
    void cbAutoHeightChanged(int state);
    void cbPlainTextChanged(int state);
    void cbMarkdownChanged(int state);
    void tabChanged(int);
