...
NCRDDemoData::NCRDDemoData()
{
}

#ifdef NCRD_STRINGLIST_DEMO
QStringList NCRDDemoData::createStringList1()
{
    //-------------------------------------------
...
QStringList NCRDDemoData::createStringList2()
{
    QStringList list;
...
QStringList NCRDDemoData::createStringListPB()
{
    QStringList list;
    return list;
}
...
NCReportDataSource *NCRDDemoData::createCustomTestData(QObject *parent)
{
    //-------------------------------------------
...
QAbstractItemModel *NCRDDemoData::createDemoItemModel()
{
    //-------------------------------------------
