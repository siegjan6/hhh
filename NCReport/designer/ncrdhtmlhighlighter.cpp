...
NCRDHtmlHighlighter::NCRDHtmlHighlighter(QTextDocument *document) : QSyntaxHighlighter(document)
{
...
NCRDHtmlHighlighter::~NCRDHtmlHighlighter()
{
    qDebug("delete highlighter");
}

void NCRDHtmlHighlighter::highlightBlock(const QString &text)
{
