...
public:
    ...
    //通过列名称和过滤条件获取列值
    QVariant value( const QString& columnname, const QString& filter) const;
...
private:
    ...
    int m_samplingSize;
    int m_currentSampleRow;
    int m_samplePeriod;
    int m_sampleNullGap;
    int m_sampleTimeFieldCol;
    QDateTime m_currentSampleDt;
    QDateTime m_minSampleDt;
    QDateTime m_maxSampleDt;

    bool m_nullRecordFlag;
    QDateTime last_cdt;
