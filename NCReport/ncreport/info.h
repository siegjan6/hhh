...
#endif
#define NCREPORTAPP_RELEASEDATE             "2015-07-28"
#define NCREPORTAPP_COPYRIGHT               VER_LEGALCOPYRIGHT_STR
#define NCREPORTAPP_WEB                     ""
