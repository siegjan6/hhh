...
public:
    ...
    bool open();
    bool nextRecord();
    bool nextRecord( NCReportDataSource* ds, bool isSamplingPageBreak = false);
    bool previousRecord();
...
private:
    ...
    bool recordPositionChange(RecordAction action, bool isSamplingPageBreak=false);
    bool recordPositionChange(RecordAction action, NCReportDataSource* ds, bool isSamplingPageBreak=false);
