...
字段控件数据类
【公有继承自标签数据类NCReportLabelData，而标签数据类NCReportLabelData有公有继承自报表数据基类NCReportItemData】
...
字段控件管理类
【公有继承自标签控件类NCReportLabelItem，而标签数据类NCReportLabelItem有公有继承自报表数据基类NCReportItem】
