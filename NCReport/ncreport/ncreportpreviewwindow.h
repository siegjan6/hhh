...
打印预览的主窗口类
【代表一个ncreportpreviewoutput对象的内容】
...
//------------------------------------------ 2015.08.18  mxl   添加
//    QAction* actionShow() const { return m_actionShow; }
//------------------------------------------ 2015.08.18  mxl   添加
...
public:
    bool exportTo(const QString &fileName, const QString& password = "", const QString& perm = "");
signals:
    void runPrinterDone();
    void runPdfDone();
    void runSvgDone();
...
//------------------------------------------ 2015.08.18  mxl   添加
    ...
    QString m_previewStyleSheetQss;
...
private:
    ...
    void saveAsPdf(QString fileName, const QString& password = "", const QString& perm = "");
