...
bool JSDataArchivesTestor::selectTestDataCase(QString testDataCaseName)
{
    ...
    if(!TestDataGroupMgr::GetInst()->GetCase(testDataCaseName, fileContentOut))
    {
...
bool JSDataArchivesTestor::start()
{
    ...
    m_pDataArchivesEngine->setDataArchives(GlobalInst::GetDataArchives());
...
bool JSDataArchivesTestor::disconnectDBSource(QString dbSourceName)
{
    ...
    IMDDataSourceManager * pDSourceMgr = GlobalInst::GetDataArchives()->dataSourceManager();
