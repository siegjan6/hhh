...
//////////////////////////////////////////////////////////////////////////
QTreeWidgetItem* CMDScriptFileNode::m_copyNode = NULL;
//////////////////////////////////////////////////////////////////////////

CMDScriptFileNode::CMDScriptFileNode()
{
    m_menu = NULL;
    m_treeView = NULL;
...
//////////////////////////////////////////////////////////////////////////
void CMDScriptFileNode::initNodes(QTreeWidgetItem *root, CMDScriptUIImp *scriptUI)
{
    ...
    //file
    QString project = scriptUI->scriptFolder();
    QDir dir(project);
    if (!dir.exists())
        dir.mkdir(project);
    getNodes(project, "*" + sExtension, root, NULL);
}
void CMDScriptFileNode::close(QTreeWidgetItem *root)
{
    resetCopyNode(root);
    clearNode(root);
}
void CMDScriptFileNode::initTreeView(QTreeWidgetItem *root)
{
    if (m_treeView != NULL)
        return;
    ...
    //bind event
    connect(m_treeView, &QTreeWidget::doubleClicked, this, &CMDScriptFileNode::treeViewDoubleClick);
    connect(m_treeView, &QTreeWidget::itemPressed, this, &CMDScriptFileNode::treeViewNodeMouseClick);
    m_treeView->installEventFilter(this);

    initMenu();
}
void CMDScriptFileNode::initRoot(QTreeWidgetItem *root, CMDScriptUIImp *scriptUI)
{
    clearNode(root);
...
void CMDScriptFileNode::initMenu()
{
    ...
    connect(m_actAddFile, &QAction::triggered, this, &CMDScriptFileNode::menuItemAddFileClick);
    connect(m_actAddDir, &QAction::triggered, this, &CMDScriptFileNode::menuItemAddDirClick);
    connect(m_actCopy, &QAction::triggered, this, &CMDScriptFileNode::menuItemCopyClick);
    connect(m_actPaste, &QAction::triggered, this, &CMDScriptFileNode::menuItemPasteClick);
    connect(m_actDel, &QAction::triggered, this, &CMDScriptFileNode::menuItemDelClick);
    connect(m_actRename, &QAction::triggered, this, &CMDScriptFileNode::menuItemRenameClick);
    ...
    connect(m_treeView, &QTreeWidget::customContextMenuRequested,
            this, &CMDScriptFileNode::menuStripNodeOpening);
}
void CMDScriptFileNode::clearNode(QTreeWidgetItem *node)
{
...
//////////////////////////////////////////////////////////////////////////
QTreeWidgetItem *CMDScriptFileNode::selectNode()
{
    if (m_treeView != NULL)
    {
...
//////////////////////////////////////////////////////////////////////////
QTreeWidgetItem *CMDScriptFileNode::getRoot(QTreeWidgetItem *node)
{
    while (node != NULL)
    {
        if (isRoot(node))
...
bool CMDScriptFileNode::isRoot(QTreeWidgetItem *node)
{
    return (QString::compare(node->data(0, Qt::UserRole).toString(), sRootName) == 0);
}
bool CMDScriptFileNode::isScriptNode(QTreeWidgetItem *node)
{
    return (QString::compare(node->data(0, Qt::UserRole).toString(), sNodeSign) == 0);
}
QTreeWidgetItem *CMDScriptFileNode::createNode(const QString &fullPath, CMDScriptFileNode::FileType type)
{
    //get name
...
QTreeWidgetItem *CMDScriptFileNode::cloneNode(QTreeWidgetItem *source)
{
...
void CMDScriptFileNode::insertSortedNode(QTreeWidgetItem *parent, QTreeWidgetItem *child)
{
...
void CMDScriptFileNode::getNodes(const QString &path, const QString &pattern, QTreeWidgetItem *parent, QTreeWidget *tree)
{
...
void CMDScriptFileNode::copyChildNodes(QTreeWidgetItem *source, QTreeWidgetItem *target)
{
...
CMDScriptUIImp *CMDScriptFileNode::getscriptUI(QTreeWidgetItem *node)
{
    QTreeWidgetItem* root = getRoot(node);
    if (root != NULL)
        return reinterpret_cast<CMDScriptUIImp*>(root->data(0, Qt::UserRole + 1).toULongLong());

    return NULL;
}
void CMDScriptFileNode::setNodeIcon(QTreeWidgetItem *node, CMDScriptFileNode::FileType type)
{
    if (type == FileType::Dir)
...
//////////////////////////////////////////////////////////////////////////
QString CMDScriptFileNode::getRelativeFilePath(QTreeWidgetItem *node)
{
    QString path;
...
CMDScriptFileNode::FileType CMDScriptFileNode::getFileType(QTreeWidgetItem *node)
{
    if (isRoot(node))
        return FileType::Dir;
...
QString CMDScriptFileNode::getFilePath(QTreeWidgetItem *node)
{
    QString project = getscriptUI(node)->scriptFolder();
    QString path;
    if (getFileType(node) == FileType::Dir)
        path.insert(0, "/");
    while(!isRoot(node))
...
void CMDScriptFileNode::copyFolder(const QString &source, const QString &target)
{
...
void CMDScriptFileNode::removeDirectory(const QString &fullName)
{
    QDir dir(fullName);
...
//////////////////////////////////////////////////////////////////////////
void CMDScriptFileNode::setMenuState(CMDScriptFileNode::NodeType type)
{
...
bool CMDScriptFileNode::isValidCopy(QTreeWidgetItem *copyNode)
{
    return copyNode != NULL && copyNode->treeWidget() != NULL;
}
QString CMDScriptFileNode::createNewName(QTreeWidgetItem *parentNode, CMDScriptFileNode::FileType type)
{
    int index = 1;
    bool hasRepeat = true;
    QString name;
...
void CMDScriptFileNode::createCopyName(QTreeWidgetItem *parentNode, QTreeWidgetItem *newNode)
{
...
void CMDScriptFileNode::nodeAfterLabelEditEvent(CMDScriptFileNode::NodeOperate operate, QTreeWidgetItem *node, const QString &oldFullName)
{
...
bool CMDScriptFileNode::isValidName(QTreeWidgetItem *node, QString &label, QString &message)
{
    if (label.isEmpty())
    {
        message = sNullHint;
...
void CMDScriptFileNode::addEvent(CMDScriptFileNode::FileType type)
{
...
void CMDScriptFileNode::resetCopyNode(QTreeWidgetItem *deleteNode)
{
...
//////////////////////////////////////////////////////////////////////////
void CMDScriptFileNode::menuStripNodeOpening(const QPoint &pos)
{
    QTreeWidgetItem* node = m_treeView->currentItem();
    if (node == NULL)
        return;
...
void CMDScriptFileNode::menuItemAddFileClick()
{
    addEvent(FileType::File);
}
void CMDScriptFileNode::menuItemAddDirClick()
{
    addEvent(FileType::Dir);
}
void CMDScriptFileNode::menuItemCopyClick()
{
    m_copyNode = selectNode();
}
void CMDScriptFileNode::menuItemPasteClick()
{
...
void CMDScriptFileNode::menuItemDelClick()
{
    QTreeWidgetItem* node = selectNode();
    QString fullName = getFilePath(node);
...
void CMDScriptFileNode::menuItemRenameClick()
{
    QTreeWidgetItem* node = selectNode();
...
bool CMDScriptFileNode::showMessage(const QString &text)
{
    QMessageBox box;
    box.setText(text);
...
void CMDScriptFileNode::setNodeEdit(QTreeWidgetItem *node)
{
    QLineEdit* edit = new QLineEdit(m_treeView);
    connect(edit, &QLineEdit::editingFinished, this, &CMDScriptFileNode::editingFinished);
...
void CMDScriptFileNode::editingFinished()
{
    QTreeWidgetItem *node = selectNode();
    if (node == NULL)
        return;
...
//////////////////////////////////////////////////////////////////////////
bool CMDScriptFileNode::eventFilter(QObject *obj, QEvent *event)
{
    if (obj == m_treeView)
    {
...
void CMDScriptFileNode::treeViewDoubleClick()
{
    QTreeWidgetItem* node = selectNode();
...
void CMDScriptFileNode::treeViewAfterLabelEdit(QTreeWidgetItem *node, QLineEdit *edit)
{
    QString message;
    ...
    if (!isValidName(node, label, message))
    {
        //移除edit
        m_treeView->removeItemWidget(node, 0);
        //disconnect(edit, &QLineEdit::editingFinished, this, &CMDScriptFileNode::editingFinished);
...
void CMDScriptFileNode::treeViewNodeMouseClick(QTreeWidgetItem *node)
{
...
bool CMDScriptFileNode::treeViewKeyDown(QKeyEvent* e)
{
...
//////////////////////////////////////////////////////////////////////////
void CMDScriptFileNode::createForm(QTreeWidgetItem *node)
{
    CMDScriptUIImp* scriptUI = getscriptUI(node);
    if (scriptUI == NULL)
        return;
    QString fullName = getFilePath(node);
...
void CMDScriptFileNode::openForm(QTreeWidgetItem *node)
{
    if (getFileType(node) != FileType::File)
        return;
...
void CMDScriptFileNode::renameForm(CMDScriptUIImp *scriptUI, QTreeWidgetItem *node, const QString &oldFullName)
{
//    if (getFileType(node) == FileType::File)
...
void CMDScriptFileNode::renameForms(QTreeWidgetItem *node, const QString &oldFullName)
{
    CMDScriptUIImp* scriptUI = getscriptUI(node);
    if (scriptUI == NULL)
        return;
...
void CMDScriptFileNode::closeForm(CMDScriptUIImp *scriptUI, QTreeWidgetItem *node)
{
//    if (getFileType(node) == FileType::File)
...
void CMDScriptFileNode::closeForms(QTreeWidgetItem *node)
{
    CMDScriptUIImp* scriptUI = getscriptUI(node);
    if (scriptUI == NULL)
        return;
