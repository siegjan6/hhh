...
#		warning "QAtomicPointer test and set is not native. The macros Log4Qt::LOG4QT_GLOBAL_STATIC and Log4Qt::LOG4QT_IMPLEMENT_IMDTANCE are not thread-safe."
#	endif
#endif
...
namespace Log4Qt
{
     ...
     *
     * \sa \ref Log4Qt::LOG4QT_IMPLEMENT_IMDTANCE "LOG4QT_IMPLEMENT_IMDTANCE",
    ...
    /*!
     * LOG4QT_IMPLEMENT_IMDTANCE implements an instance function for a
     ...
     * {}
     *
     * LOG4QT_IMPLEMENT_IMDTANCE(MySingleton)
     *
     * \endcode
     *
     * \note The function created by the macro is thread-safe.
     ...
     */
#if QT_VERSION < QT_VERSION_CHECK(4, 4, 0)
	#define LOG4QT_IMPLEMENT_IMDTANCE(TYPE)                                   \
     ...
     * \ref Log4Qt::LOG4QT_IMPLEMENT_IMDTANCE "LOG4QT_IMPLEMENT_IMDTANCE").
	 *
