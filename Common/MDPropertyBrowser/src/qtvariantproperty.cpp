...
public:
    ...
    void slotUpdateValue(QtProperty *property, int val);
    void slotUpdateValue(QtProperty *property, double val);
    void slotUpdateValue(QtProperty *property, bool val);
    void slotUpdateValue(QtProperty *property, const QString &val);
    void slotUpdateValue(QtProperty *property, const QDate &val);
    void slotUpdateValue(QtProperty *property, const QTime &val);
    void slotUpdateValue(QtProperty *property, const QDateTime &val);
    void slotUpdateValue(QtProperty *property, const QKeySequence &val);
    void slotUpdateValue(QtProperty *property, const QChar &val);
    void slotUpdateValue(QtProperty *property, const QLocale &val);
    void slotUpdateValue(QtProperty *property, const QPoint &val);
    void slotUpdateValue(QtProperty *property, const QPointF &val);
    void slotUpdateValue(QtProperty *property, const QSize &val);
    void slotUpdateValue(QtProperty *property, const QSizeF &val);
    void slotUpdateValue(QtProperty *property, const QRect &val);
    void slotUpdateValue(QtProperty *property, const QRectF &val);
    void slotUpdateValue(QtProperty *property, const QColor &val);
    void slotUpdateValue(QtProperty *property, const QSizePolicy &val);
    void slotUpdateValue(QtProperty *property, const QFont &val);
    void slotUpdateValue(QtProperty *property, const QCursor &val);
            ...
            QtVariantProperty *after, QtProperty *internal)
{
    ...
    QtVariantProperty *varChild = q_ptr->addProperty(type, internal->propertyName(),internal->markText());

    m_creatingSubProperties = wasCreatingSubProperties;

    varChild->setPropertyName(internal->propertyName());
    varChild->setMarkText(internal->markText());
...
void QtVariantPropertyManagerPrivate::valueChanged(QtProperty *property, const QVariant &val)
{
    ...
    if (!varProp)
        return;
    varProp->setSource(property->source());
...
void QtVariantPropertyManagerPrivate::updateValue(QtProperty *property,const QVariant &val)
{
    QtVariantProperty *varProp = m_internalToProperty.value(property, 0);
    if (!varProp)
        return;
    emit q_ptr->updatePropertyOutside(varProp,val);
}

void QtVariantPropertyManagerPrivate::slotUpdateValue(QtProperty *property, int val)
{
    updateValue(property,QVariant(val));
}

void QtVariantPropertyManagerPrivate::slotUpdateValue(QtProperty *property, double val)
{
    updateValue(property,QVariant(val));
}
void QtVariantPropertyManagerPrivate::slotUpdateValue(QtProperty *property, const QTime &val)
{
    updateValue(property,QVariant(val));
}

void QtVariantPropertyManagerPrivate::slotUpdateValue(QtProperty *property, const QString &val)
{
    updateValue(property,QVariant(val));
}

void QtVariantPropertyManagerPrivate::slotUpdateValue(QtProperty *property, const QSizePolicy &val)
{
    updateValue(property,QVariant(val));
}

void QtVariantPropertyManagerPrivate::slotUpdateValue(QtProperty *property, const QSize &val)
{
    updateValue(property,QVariant(val));
}

void QtVariantPropertyManagerPrivate::slotUpdateValue(QtProperty *property, const QSizeF &val)
{
    updateValue(property,QVariant(val));
}

void QtVariantPropertyManagerPrivate::slotUpdateValue(QtProperty *property, const QRect &val)
{
    updateValue(property,QVariant(val));
}

void QtVariantPropertyManagerPrivate::slotUpdateValue(QtProperty *property, const QRectF &val)
{
    updateValue(property,QVariant(val));
}

void QtVariantPropertyManagerPrivate::slotUpdateValue(QtProperty *property, const QPoint &val)
{
    updateValue(property,QVariant(val));
}

void QtVariantPropertyManagerPrivate::slotUpdateValue(QtProperty *property, const QPointF &val)
{
    updateValue(property,QVariant(val));
}

void QtVariantPropertyManagerPrivate::slotUpdateValue(QtProperty *property, const QLocale &val)
{
    updateValue(property,QVariant(val));
}

void QtVariantPropertyManagerPrivate::slotUpdateValue(QtProperty *property, const QKeySequence &val)
{
    QVariant v;
    qVariantSetValue(v, val);
    updateValue(property,v);
}
void QtVariantPropertyManagerPrivate::slotUpdateValue(QtProperty *property, const QFont &val)
{
    updateValue(property,QVariant(val));
}
void QtVariantPropertyManagerPrivate::slotUpdateValue(QtProperty *property, const QDateTime &val)
{
    updateValue(property,QVariant(val));
}

void QtVariantPropertyManagerPrivate::slotUpdateValue(QtProperty *property, const QDate &val)
{
    updateValue(property,QVariant(val));
}
void QtVariantPropertyManagerPrivate::slotUpdateValue(QtProperty *property, const QCursor &val)
{
    updateValue(property,QVariant(val));
}

void QtVariantPropertyManagerPrivate::slotUpdateValue(QtProperty *property, const QColor &val)
{
    updateValue(property,QVariant(val));
}
void QtVariantPropertyManagerPrivate::slotUpdateValue(QtProperty *property, const QChar &val)
{
    updateValue(property,QVariant(val));
}
void QtVariantPropertyManagerPrivate::slotUpdateValue(QtProperty *property, bool val)
{
    updateValue(property,QVariant(val));
}
    ...
    : QtAbstractPropertyManager(parent)
{
    ...
    connect(intPropertyManager,SIGNAL(updatePropertyOutside(QtProperty*,int)),
                this,SLOT(slotUpdateValue(QtProperty *, int)));
    // DoublePropertyManager #2
    ...
    connect(doublePropertyManager, SIGNAL(updatePropertyOutside(QtProperty *, double)),
                this, SLOT(slotUpdateValue(QtProperty *, double)));
    // BoolPropertyManager #3
    ...
    connect(boolPropertyManager, SIGNAL(updatePropertyOutside(QtProperty *, bool)),
                this, SLOT(slotUpdateValue(QtProperty *, bool)));
    // StringPropertyManager #4
    ...
    connect(stringPropertyManager, SIGNAL(updatePropertyOutside(QtProperty *, const QString &)),
                this, SLOT(slotUpdateValue(QtProperty *, const QString &)));

    // DatePropertyManager #5
    ...
    connect(datePropertyManager, SIGNAL(updatePropertyOutside(QtProperty *, const QDate &)),
                this, SLOT(slotUpdateValue(QtProperty *, const QDate &)));
    // TimePropertyManager #6
    ...
    connect(timePropertyManager, SIGNAL(updatePropertyOutside(QtProperty *, const QTime &)),
                this, SLOT(slotUpdateValue(QtProperty *, const QTime &)));
    // DateTimePropertyManager #7
    ...
    connect(dateTimePropertyManager, SIGNAL(updatePropertyOutside(QtProperty *, const QDateTime &)),
                this, SLOT(slotUpdateValue(QtProperty *, const QDateTime &)));
    // KeySequencePropertyManager #8
    ...
    connect(keySequencePropertyManager, SIGNAL(updatePropertyOutside(QtProperty *, const QKeySequence &)),
                this, SLOT(slotUpdateValue(QtProperty *, const QKeySequence &)));

    // CharPropertyManager #9
    ...
    connect(charPropertyManager, SIGNAL(updatePropertyOutside(QtProperty *, const QChar &)),
                this, SLOT(slotUpdateValue(QtProperty *, const QChar &)));
    // LocalePropertyManager #10
    ...
    connect(localePropertyManager, SIGNAL(updatePropertyOutside(QtProperty *, const QLocale &)),
                this, SLOT(slotUpdateValue(QtProperty *, const QLocale &)));

    // PointPropertyManager #11
    ...
    connect(pointPropertyManager, SIGNAL(updatePropertyOutside(QtProperty *, const QPoint &)),
                this, SLOT(slotUpdateValue(QtProperty *, const QPoint &)));

    // PointFPropertyManager #12
    ...
    connect(pointFPropertyManager, SIGNAL(updatePropertyOutside(QtProperty *, const QPointF &)),
                this, SLOT(slotUpdateValue(QtProperty *, const QPointF &)));
    // SizePropertyManager #13
    ...
    connect(sizePropertyManager, SIGNAL(updatePropertyOutside(QtProperty *, const QSize &)),
                this, SLOT(slotUpdateValue(QtProperty *, const QSize &)));

    // SizeFPropertyManager #14
    ...
    connect(sizeFPropertyManager, SIGNAL(updatePropertyOutside(QtProperty *, const QSizeF &)),
                this, SLOT(slotUpdateValue(QtProperty *, const QSizeF &)));

    // RectPropertyManager #15
    ...
    connect(rectPropertyManager, SIGNAL(updatePropertyOutside(QtProperty *, const QRect &)),
                this, SLOT(slotUpdateValue(QtProperty *, const QRect &)));

    // RectFPropertyManager #16
    ...
    connect(rectFPropertyManager, SIGNAL(updatePropertyOutside(QtProperty *, const QRectF &)),
                this, SLOT(slotUpdateValue(QtProperty *, const QRectF &)));

    // ColorPropertyManager #17
    ...
    connect(colorPropertyManager, SIGNAL(updatePropertyOutside(QtProperty *, const QColor &)),
                this, SLOT(slotUpdateValue(QtProperty *, const QColor &)));

    // EnumPropertyManager #18
    ...
    connect(enumPropertyManager, SIGNAL(updatePropertyOutside(QtProperty *, int)),
                this, SLOT(slotUpdateValue(QtProperty *, int)));

    // SizePolicyPropertyManager #19
    ...
    connect(sizePolicyPropertyManager, SIGNAL(updatePropertyOutside(QtProperty *, const QSizePolicy &)),
                this, SLOT(slotUpdateValue(QtProperty *, const QSizePolicy &)));

    // FontPropertyManager #20
    ...
    connect(fontPropertyManager, SIGNAL(updatePropertyOutside(QtProperty *, const QFont &)),
                this, SLOT(slotUpdateValue(QtProperty *, const QFont &)));

    // CursorPropertyManager #21
    ...
    connect(cursorPropertyManager, SIGNAL(updatePropertyOutside(QtProperty *, const QCursor &)),
                this, SLOT(slotUpdateValue(QtProperty *, const QCursor &)));
    // FlagPropertyManager #22
    ...
    connect(flagPropertyManager, SIGNAL(updatePropertyOutside(QtProperty *, int)),
                this, SLOT(slotUpdateValue(QtProperty *, int)));
    // FlagPropertyManager
...
*/
QtVariantProperty *QtVariantPropertyManager::addProperty(int propertyType, const QString &name,const QString &markText)
{
    ...
    QtProperty *property = QtAbstractPropertyManager::addProperty(name,markText);
...
void QtVariantPropertyManager::setValue(QtProperty *property, const QVariant &val)
{
    ...
    if (internProp == 0)
        return;
    internProp->setSource(property->source());
//connlaio
    QtAbstractPropertyManager *manager = internProp->propertyManager();
    if (QtIntPropertyManager *intManager = qobject_cast<QtIntPropertyManager *>(manager)) {
        intManager->setValue(internProp, qVariantValue<int>(val)); //edited
        return;
    } else if (QtDoublePropertyManager *doubleManager = qobject_cast<QtDoublePropertyManager *>(manager)) {
        doubleManager->setValue(internProp, qVariantValue<double>(val));//edited
        return;
    } else if (QtBoolPropertyManager *boolManager = qobject_cast<QtBoolPropertyManager *>(manager)) {
        boolManager->setValue(internProp, qVariantValue<bool>(val)); //edited
        return;
    } else if (QtStringPropertyManager *stringManager = qobject_cast<QtStringPropertyManager *>(manager)) {
        stringManager->setValue(internProp, qVariantValue<QString>(val));//edited
        return;
    } else if (QtDatePropertyManager *dateManager = qobject_cast<QtDatePropertyManager *>(manager)) {
        dateManager->setValue(internProp, qVariantValue<QDate>(val));//edited
        return;
    } else if (QtTimePropertyManager *timeManager = qobject_cast<QtTimePropertyManager *>(manager)) {
        ...
        localeManager->setValue(internProp, qVariantValue<QLocale>(val));//edited
        return;
    } else if (QtPointPropertyManager *pointManager = qobject_cast<QtPointPropertyManager *>(manager)) {
        pointManager->setValue(internProp, qVariantValue<QPoint>(val));//edited
        return;
    } else if (QtPointFPropertyManager *pointFManager = qobject_cast<QtPointFPropertyManager *>(manager)) {
        pointFManager->setValue(internProp, qVariantValue<QPointF>(val));//edited
        return;
    } else if (QtSizePropertyManager *sizeManager = qobject_cast<QtSizePropertyManager *>(manager)) {
        ...
        rectManager->setValue(internProp, qVariantValue<QRect>(val)); //edited
        return;//connlaio
    } else if (QtRectFPropertyManager *rectFManager = qobject_cast<QtRectFPropertyManager *>(manager)) {
        rectFManager->setValue(internProp, qVariantValue<QRectF>(val)); //edited
        return;
    } else if (QtColorPropertyManager *colorManager = qobject_cast<QtColorPropertyManager *>(manager)) {
        colorManager->setValue(internProp, qVariantValue<QColor>(val));//edited
        return;
    } else if (QtEnumPropertyManager *enumManager = qobject_cast<QtEnumPropertyManager *>(manager)) {
        enumManager->setValue(internProp, qVariantValue<int>(val)); //edited
        return;
    } else if (QtSizePolicyPropertyManager *sizePolicyManager =
               qobject_cast<QtSizePolicyPropertyManager *>(manager)) {
        sizePolicyManager->setValue(internProp, qVariantValue<QSizePolicy>(val)); //edited
        return;
    } else if (QtFontPropertyManager *fontManager = qobject_cast<QtFontPropertyManager *>(manager)) {
        fontManager->setValue(internProp, qVariantValue<QFont>(val)); //edited
        return;
#ifndef QT_NO_CURSOR
    } else if (QtCursorPropertyManager *cursorManager = qobject_cast<QtCursorPropertyManager *>(manager)) {
        cursorManager->setValue(internProp, qVariantValue<QCursor>(val)); //edited
        return;
#endif
    } else if (QtFlagPropertyManager *flagManager = qobject_cast<QtFlagPropertyManager *>(manager)) {
        flagManager->setValue(internProp, qVariantValue<int>(val)); //edited
        return;
    }
}
        ...
        const QString &attribute, const QVariant &value)
{
    ...
    if (QtIntPropertyManager *intManager = qobject_cast<QtIntPropertyManager *>(manager)) {
        ...
        if (attribute == d_ptr->m_decimalsAttribute)//connlaio
...
{//connlaio
    ...
    if (it != d_ptr->m_typeToPropertyManager.constEnd()) {
        ...
        if (!d_ptr->m_creatingSubProperties) {
            ...
            internProp = manager->addProperty(property->propertyName(),property->markText());//!mark
