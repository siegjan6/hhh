...
*/
CMDExtSerialPort::CMDExtSerialPort()
 : QextBaseType()
{}
...
\see setQueryMode().
*/
CMDExtSerialPort::CMDExtSerialPort(const QString & name, QueryMode mode)
...
\see setQueryMode().
*/
CMDExtSerialPort::CMDExtSerialPort(PortSettings const& settings, QueryMode mode)
...
\see setQueryMode().
*/
CMDExtSerialPort::CMDExtSerialPort(const QString & name, PortSettings const& settings, QueryMode mode)
...
\deprecated
*/
CMDExtSerialPort::CMDExtSerialPort(const CMDExtSerialPort& s)
 : QextBaseType(s)
{}

/*!
\fn QextSerialPort& QextSerialPort::operator=(const QNSExtSerialPort& s)
Overrides the = operator.

\deprecated
*/
CMDExtSerialPort& CMDExtSerialPort::operator=(const CMDExtSerialPort& s)
{
    return (CMDExtSerialPort&)QextBaseType::operator=(s);
}

/*!
\fn QextSerialPort::~QNSExtSerialPort()
Standard destructor.
*/
CMDExtSerialPort::~CMDExtSerialPort()
{}
