	...
	UA_Variant        *output)
{
	...
	Q_ASSERT_X(retType != QMetaType::UnknownType ||
		...
		"QUaServer::callMetaMethod",
        QString("Return type " +QString(retType) + " "+ QString(metaMethod.typeName()) + " is not registered. Try using qRegisterMetaType.").toLocal8Bit().data()
	);
...
//UA_Server * QUaServer::getServer()
//{
//    return m_server;
//}

QUaServer* QUaServer::s_uniqueObj = nullptr;
...
//QUaServer* QUaServer::Instance()
//{
//    #pragma comment(linker, "/SECTION:SHARED,RWS")
//    #pragma data_seg("Shared")
//    static QUaServer* _instance = NULL;
//    #pragma data_seg()
//    if(_instance == NULL)
//    {
//        _instance = new QUaServer();
//        qDebug() << "QUaServer instance count++";
//    }
//    return _instance;
//}

//QUaServer* GetUaInstance()
//{
//    return QUaServer::Instance();
//}
