...
class MDUASERVER_EXPORT QUaBaseVariable : public QUaNode
{
	Q_OBJECT
	// Variable Attributes
...
public:
	...
	*/
	...
	void              setWriteCallback(const std::function<QVariant()>& writeCallback = std::function<QVariant()>());
...
signals:
	...
	void valueChangedFromClient(const QVariant&      value, const bool &networkChange);
...
private:
	...
	std::function<QVariant()> m_writeCallback;
	bool m_writeCallbackRunning = false;
#ifdef UA_ENABLE_HISTORIZING
