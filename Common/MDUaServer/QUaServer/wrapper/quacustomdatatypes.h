...
union QUaWriteMask
{
    struct bit_map {
        ...
        bool bContainsNoLoops         : 1; // UA_WRITEMASK_CONTAIMDNOLOOPS
...
class MDUASERVER_EXPORT QUaDataType
{
...
public:
    ...
    static QMetaType::Type    qTypeByType(const UA_DataType* type);
...
class MDUASERVER_EXPORT QUaStatusCode
{
...
class MDUASERVER_EXPORT QUaNodeId
{
public:
    QUaNodeId();
    ~QUaNodeId();
...
class MDUASERVER_EXPORT QUaLocalizedText
{
public:
    QUaLocalizedText();
...
class MDUASERVER_EXPORT QUaQualifiedName
{
...
class MDUASERVER_EXPORT QUaChangeStructureDataType
{
public:
...
class MDUASERVER_EXPORT QUaExclusiveLimitState
{
public:
...
class MDUASERVER_EXPORT QUaExclusiveLimitTransition
{
public:
...
class MDUASERVER_EXPORT QUaSignaler : public QObject
{
    Q_OBJECT
public:
...
class MDUASERVER_EXPORT QUaSession : public QObject
{
...
class MDUASERVER_EXPORT QUaEventHistoryQueryData
{
