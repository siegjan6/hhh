...
QMetaType::Type QUaDataType::qTypeByType(const UA_DataType* type)
{
    if (type == &UA_TYPES[UA_TYPES_BOOLEAN]) {
        return qTypeByTypeIndex((int)UA_TYPES_BOOLEAN);
    }
    else if (type == &UA_TYPES[UA_TYPES_SBYTE]) {
        return qTypeByTypeIndex((int)UA_TYPES_SBYTE);
    }
    else if (type == &UA_TYPES[UA_TYPES_BYTE]) {
        return qTypeByTypeIndex((int)UA_TYPES_BYTE);
    }
    else if (type == &UA_TYPES[UA_TYPES_INT16]) {
        return qTypeByTypeIndex((int)UA_TYPES_INT16);
    }
    else if (type == &UA_TYPES[UA_TYPES_UINT16]) {
        return qTypeByTypeIndex((int)UA_TYPES_UINT16);
    }
    else if (type == &UA_TYPES[UA_TYPES_INT32]) {
        return qTypeByTypeIndex((int)UA_TYPES_INT32);
    }
    else if (type == &UA_TYPES[UA_TYPES_UINT32]) {
        return qTypeByTypeIndex((int)UA_TYPES_UINT32);
    }
    else if (type == &UA_TYPES[UA_TYPES_INT64]) {
        return qTypeByTypeIndex((int)UA_TYPES_INT64);
    }
    else if (type == &UA_TYPES[UA_TYPES_UINT64]) {
        return qTypeByTypeIndex((int)UA_TYPES_UINT64);
    }
    else if (type == &UA_TYPES[UA_TYPES_FLOAT]) {
        return qTypeByTypeIndex((int)UA_TYPES_FLOAT);
    }
    else if (type == &UA_TYPES[UA_TYPES_DOUBLE]) {
        return qTypeByTypeIndex((int)UA_TYPES_DOUBLE);
    }
    else if (type == &UA_TYPES[UA_TYPES_STRING]) {
        return qTypeByTypeIndex((int)UA_TYPES_STRING);
    }
    // TODO: datetime type converter
    else if (type == &UA_TYPES[UA_TYPES_DATETIME]) {
        return qTypeByTypeIndex((int)UA_TYPES_DATETIME);
    }
    else if (type == &UA_TYPES[UA_TYPES_GUID]) {
        return qTypeByTypeIndex((int)UA_TYPES_GUID);
    }
    else if (type == &UA_TYPES[UA_TYPES_BYTESTRING]) {
        return qTypeByTypeIndex((int)UA_TYPES_BYTESTRING);
    }
    else if (type == &UA_TYPES[UA_TYPES_VARIANT]) {
        return qTypeByTypeIndex((int)UA_TYPES_VARIANT);
    }
    else if (type == &UA_TYPES[UA_TYPES_NODEID]) {
        return qTypeByTypeIndex((int)UA_TYPES_NODEID);
    }
    else if (type == &UA_TYPES[UA_TYPES_STATUSCODE]) {
        return qTypeByTypeIndex((int)UA_TYPES_STATUSCODE);
    }
    else if (type == &UA_TYPES[UA_TYPES_QUALIFIEDNAME]) {
        return qTypeByTypeIndex((int)UA_TYPES_QUALIFIEDNAME);
    }
    else if (type == &UA_TYPES[UA_TYPES_LOCALIZEDTEXT]) {
        return qTypeByTypeIndex((int)UA_TYPES_LOCALIZEDTEXT);
    }
#ifdef UA_ENABLE_SUBSCRIPTIONS_EVENTS
    else if (type == &UA_TYPES[UA_TYPES_TIMEZONEDATATYPE]) {
        return qTypeByTypeIndex((int)UA_TYPES_TIMEZONEDATATYPE);
    }
    else if (type == &UA_TYPES[UA_TYPES_MODELCHANGESTRUCTUREDATATYPE]) {
        return qTypeByTypeIndex((int)UA_TYPES_MODELCHANGESTRUCTUREDATATYPE);
    }
#endif // UA_ENABLE_SUBSCRIPTIONS_EVENTS
