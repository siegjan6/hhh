...
QUaOffNormalAlarm* QUaNode::addOffNormalAlarm(
	const QUaQualifiedName& browseName,
	const QUaNodeId& nodeId/* = ""*/
)
{
	return m_qUaServer->createInstance<QUaOffNormalAlarm>(this, browseName, nodeId);
}

QUaExclusiveLevelAlarm* QUaNode::addExclusiveLevelAlarm(
        const QUaQualifiedName& browseName,
        const QUaNodeId& nodeId/* = ""*/
        )
{
    return m_qUaServer->createInstance<QUaExclusiveLevelAlarm>(this, browseName, nodeId);
}

void QUaNode::removeBaseObject(const bool& deleteReferences/* = true*/)
{
	// remove the reference
	auto st = UA_Server_deleteNode(
...
{
	// get all ua methods of IMDTANCE
