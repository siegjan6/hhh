...
class MDUASERVER_EXPORT QUaServer : public QObject
{
...
//    UA_Server * getServer();
//    static QUaServer* Instance();

    DECLEAR_SINGLETON(QUaServer)
};

#define G_UASERVER QUaServer::Instance()

//#pragma comment(linker, "/SECTION:Shared,RWS")
//#pragma data_seg("Shared")

//static QUaServer* G_UASERVER = QUaServer::Instance();

//extern QUaServer* GetUaInstance();
//#pragma data_seg()
