...
sptr_t Editor::WndProc(unsigned int iMessage, uptr_t wParam, sptr_t lParam) {
	...
	case SCI_SETMAIMDELECTION:
		sel.SetMain(wParam);
		Redraw();
		break;

	case SCI_GETMAIMDELECTION:
		return sel.Main();
