...
public:
    ...
    enum
    {
        ...
        //!
        //! \sa SCI_GETMARGIMDENSITIVEN, SCN_MARGINCLICK()
        SCI_SETMARGIMDENSITIVEN = 2246,

        //! This message returns the sensitivity of a margin to mouse clicks.
        //! \a wParam is the number of the margin.
        //!
        //! \sa SCI_SETMARGIMDENSITIVEN, SCN_MARGINCLICK()
        SCI_GETMARGIMDENSITIVEN = 2247,
        ...
        //!
        SCI_MARGIMDETTEXT = 2530,

        //!
        SCI_MARGINGETTEXT = 2531,

        //!
        SCI_MARGIMDETSTYLE = 2532,

        //!
        SCI_MARGINGETSTYLE = 2533,

        //!
        SCI_MARGIMDETSTYLES = 2534,
        ...
        //!
        SCI_SETMAIMDELECTION = 2574,

        //!
        SCI_GETMAIMDELECTION = 2575,
        ...
        //!
        SCI_AUTOCSETCASEIMDENSITIVEBEHAVIOUR = 2634,

        //!
        SCI_AUTOCGETCASEIMDENSITIVEBEHAVIOUR = 2635,
    ...
    enum
    {
        SC_CASEIMDENSITIVEBEHAVIOUR_RESPECTCASE = 0,
        SC_CASEIMDENSITIVEBEHAVIOUR_IGNORECASE = 1,
    };
...
signals:
    ...
    //! 
    //! \sa SCI_GETMARGIMDENSITIVEN, SCI_SETMARGIMDENSITIVEN
