...
private slots:
    ...
    /*!
     * \brief on_registerComboBox_currentIndexChanged
     * 寄存器选择时，如果当前寄存器不属于对应plc，
     * 屏蔽掉开始及结束地址的设置。
     */
    void registerComboBox_currentIndexChanged(int index);//PKX
    /*!
    ...
    void dbNumberEdit_editingFinished();
