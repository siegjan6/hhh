...
class CMDDevice:public CBaseDevice
{
    ...
    Q_PROPERTY(QString MPIStationAddress READ mpiStationAddress_Pro WRITE setMPIStationAddress_Pro)
...
public:
    ...
    //!MPI站地址
    QString mpiStationAddress_Pro();
    void setMPIStationAddress_Pro(QString station);
    //!机架号
    QString cpuRack_Pro();
...
private:
    ...
    QString m_mpiStationAddress_Pro;
...
public:
    ...
    void setMPIStation(QString station);
    QString MPIStation();
...
public:
    qint8 activeNO();
    void setActiveNO(qint8 num);
private:
    qint8 m_nActiveNO;//!与PLC初始化标志位
public:
