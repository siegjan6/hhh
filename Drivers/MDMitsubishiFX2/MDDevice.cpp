...
CMDDevice::CMDDevice()
{
    ...
    //***************************************************************//
    //************************属性框变量-设备参数***********************//
    m_commProtocol_Pro = "MitsubishiFX2";
    m_replyTimeout_Pro = "1000";
    m_retries_Pro = "3";
    m_plcType_Pro = (MDPlcType_Pro)3;
    //***************************************************************//
}
CMDDevice::~CMDDevice()
{
...
{
    m_PLCType = PLCType;
    m_plcType_Pro = (MDPlcType_Pro)m_PLCType;//!属性框
}
//通信类型
...
void CMDDevice::deserialize(const QJsonObject &json)
{
    ...
    this->setPLCType(this->PLCTypeStringToIndex(json.value("PLCType").toString("3")));
...
qint16 CMDDevice::PLCTypeStringToIndex(QString str)
{
    ...
    if(0==QString::compare(str,"FX",Qt::CaseInsensitive))
    {
        nPLCType = 0;
    }
    else if(0==QString::compare(str,"FX0",Qt::CaseInsensitive))
    {
        nPLCType = 1;
    }
    else if(0==QString::compare(str,"FX0N",Qt::CaseInsensitive))
    {
        nPLCType = 2;
    }
    else if(0==QString::compare(str,"FX2N",Qt::CaseInsensitive))
    {
        nPLCType = 3;
    }
    return nPLCType;
...
void CMDDevice::initTranslateNameAndPropertyType()
{
    ...
    //!PLC类型
    m_translateName.insert(QString("PlcType"),QString("设备类型"));
    m_propertyTip.insert(QString("PlcType"),QString("设备类型"));
    //**********************************************************************//
...
void CMDDevice::setPlcType_Pro(CMDDevice::MDPlcType_Pro plc)
{
    m_plcType_Pro = plc;
