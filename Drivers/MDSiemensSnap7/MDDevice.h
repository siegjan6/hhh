...
class CMDDevice:public CBaseDevice
{
    ...
    Q_ENUMS(MDRackAndSlotOrTSAP_Pro)
    Q_PROPERTY(MDRackAndSlotOrTSAP_Pro RackAndSlotOrTSAP READ rackAndSlotOrTSAP_Pro WRITE setRackAndSlotOrTSAP_Pro)
    Q_PROPERTY(QString CPURack READ cpuRack_Pro WRITE setCPURack_Pro)
    Q_PROPERTY(QString CPUSlot READ cpuSlot_Pro WRITE setCPUSlot_Pro)
    Q_PROPERTY(QString LocalTSAP READ localTSAP_Pro WRITE setLocalTSAP_Pro)
    Q_PROPERTY(QString RemoteTSAP READ remoteTSAP_Pro WRITE setRemoteTSAP_Pro)
    //*******************************************************************************//
public:
    CMDDevice();
    ~CMDDevice();
    ...
    enum class  MDRackAndSlotOrTSAP_Pro
    {
        RackAndSlot = 0,
        TSAP = 1,
    };
...
public:
    ...
    //!Rack/Slot Or TSAP
    MDRackAndSlotOrTSAP_Pro rackAndSlotOrTSAP_Pro();
    void setRackAndSlotOrTSAP_Pro(MDRackAndSlotOrTSAP_Pro point);
    //!机架号
    QString cpuRack_Pro();
    void setCPURack_Pro(QString rack);
    //!槽号
    QString cpuSlot_Pro();
    void setCPUSlot_Pro(QString slot);
    //!本地传输服务访问点
    QString localTSAP_Pro();
    void setLocalTSAP_Pro(QString ltsap);
    //!传输服务访问点
    QString remoteTSAP_Pro();
    void setRemoteTSAP_Pro(QString rtsap);
    //*******************************************************************//
private slots:
...
private:
    ...
    MDRackAndSlotOrTSAP_Pro m_rackAndSlotOrTSAP_Pro;
    QString m_commProtocol_Pro;
    QString m_cpuRack_Pro;
    QString m_cpuSlot_Pro;
    QString m_localTSAP_Pro;
    QString m_remoteTSAP_Pro;
    //******************************************************************//
public:
    bool start();
    bool stop();
...
public:
    ...
    void setLocalTSAP(QString LocalTSAP);
    QString LocalTSAP();
    /*!
     * \section
     * 通信ID设置获取
     */
    void setRemoteTSAP(QString RemoteTSAP);
    QString RemoteTSAP();
    /*!
     * \brief setPLCType
     * PLC型号设置
    ...
    QString transportModelIndexToString(qint16 index);
    qint16 transportModelStringToIndex(QString str);
...
private:
    ...
    qint16 m_PLCType;//!PLC型号
    QString m_LocalTSAP;//!通信ID
    QString m_RemoteTSAP;//!通信ID
...
public:
 ...
 public:
    qint32 m_nPLCComInitialStatus;//!与PLC初始化标志位
public:
