...
class CMDDevice:public CBaseDevice
{
    ...
    Q_ENUMS(MDPLCType_Pro)
    Q_PROPERTY(MDPLCType_Pro PLCType READ plcType_Pro WRITE setPLCType_Pro)
...
public:
    ...
    //!Rack/Slot Or TSAP
    MDPLCType_Pro plcType_Pro();
    void setPLCType_Pro(MDPLCType_Pro plc);
    //!机架号
    QString cpuRack_Pro();
...
public:
    ...
    QString PLCTypeIndexToString(qint16 index);
    qint16 PLCTypeStringToIndex(QString str);
