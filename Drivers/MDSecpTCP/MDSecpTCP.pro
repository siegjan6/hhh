...
SOURCES += \
    ...
    MDSecpTCP.cpp \
    MDVarTable.cpp \
    MDDeviceParameterGetConfig.cpp \
    MDVarInformation.cpp
...
TARGET = Mind.RTDB.Drivers.MDSecpTCP
LIBS +=  \
        -L../../bin/debug\
