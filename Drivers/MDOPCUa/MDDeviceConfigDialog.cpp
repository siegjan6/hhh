...
void CMDDeviceConfigDialog::setDevice(CMDDevice *device)
{
    ...
    if(m_device!=NULL)
    {
        ...
        else if(m_device->commType()== CommunicationType::OPCUA)
        {
            QStringList  paramList = m_device->commParameter().split(',');
            ui->communicationTypeBox->setCurrentIndex(3);
            ui->stackedWidget->setCurrentIndex(2);
            ui->opcuaCommParameterEdit->setText(m_device->commParameter());
//            if(paramList.size()>4)
//            {
//                ui->serverIPEdit->setText(paramList.at(1));
//                ui->serverPortEdit->setText(paramList.at(2));
...
//            }
        ...
        {
            ui->communicationTypeBox->setCurrentIndex(6);
...
void CMDDeviceConfigDialog::okButton_clicked()
{
    if(m_device!=NULL)
    {
        ...
        else if(ui->communicationTypeBox->currentIndex()== 3)
        {
            ...
            m_device->setCommType(CommunicationType::OPCUA);
            m_device->setCommParameter(ui->opcuaCommParameterEdit->text());
        }
        ...
        else if(ui->communicationTypeBox->currentIndex()== 5)
        {
        ...
        {
            if(m_device->commType()!=(CommunicationType)100)
            {
                m_device->hideAllAndShowOne_Pro((CommunicationType)100);
            }
        ...
        m_device->setStation_Pro(ui->stationEdit->text());
