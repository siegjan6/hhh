...
CMDDevice::CMDDevice()
{
    ...
    m_commParameter = "Client,127.0.0.1,502,,";
    m_station= 1;
    ...
    //***************************************************************//
    //************************属性框变量-设备参数***********************//
    m_commProtocol_Pro = "ModbusTcp/Ip";
...
void CMDDevice::deserialize(const QJsonObject &json)
{
    ...
    this->setCommType((CommunicationType)this->commTypeStringToEnum(json.value("CommType").toString("1")));
    this->setCommParameter(this->commParameterStringToIndex(json.value("CommParameter").toString("Client,127.0.0.1,502,,")));
