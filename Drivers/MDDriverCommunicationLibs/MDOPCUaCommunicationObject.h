/*!
\author bosmutus
\section OPCUa通信，由CMDCommunicationComponent对象创建，目前支持OPCUa客户端
*/
#ifndef MDOPCUACOMMUNICATIONOBJECT_H
#define MDOPCUACOMMUNICATIONOBJECT_H
...
class OPCUaClient;
class CMDOPCUaCommunicationObject:public ICommunicationObject//public QObject,public ICommunicationObject//,public ICommunicationObjectEx
{
    Q_OBJECT
public:
    CMDOPCUaCommunicationObject();
    ~CMDOPCUaCommunicationObject();
    //通信状态
...
//    QTcpSocket *m_pTcpSocket;
    ...
    std::vector<std::string> m_entityBrowseNames;
