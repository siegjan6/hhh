...
private:
    ...
    qint32 m_nAreaCode;         //!软元件代码
    qint32 m_mdimStart;           //!起始软元件
    qint32 m_nRevLen;             //!数据长度
...
public:
     ...
     * \brief setAreaCode:
        * 软元件代码设置.
     */
    void setAreaCode(qint32 areacode);
    /*!
     * \brief simStar:
        * 起始软元件获取.
     */
     ...
     * \brief setSimStar:
        * 起始软元件设置.
     */
    void setSimStar(qint32 simstar);
    /*!
     * \brief revLen:
        * 数据长度获取.
     */
...
public:
    ...
    int verifyLength(qint32 startAddress,qint32 endAddress,qint16 nLength);
    void overallVerify();
};
