...
SOURCES += \
    ...
    MDPLC.cpp \
    MDRegisterAndAddressConfigTab.cpp
...
HEADERS +=\
    ...
    MDPLC.h \
    MDRegisterAndAddressConfigTab.h
...
#TARGET = Mind.RTDB.Drivers.MDPLC
TARGET = MDDRV.MindTechPLCC
LIBS +=  \
        -L../../bin/debug\
...
FORMS += \
    ...
    MDRegisterAndAddressConfigTab.ui
