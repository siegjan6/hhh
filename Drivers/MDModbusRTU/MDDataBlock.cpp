...
//    if(m_registerType == 0||m_registerType == 1)
//    {
//        m_dataBufferSize= (qint16)(m_endAddress - m_startAddress+1);
//        if((m_dataBufferSize % 8)!=0)
//        {
//            m_dataBufferSize= m_dataBufferSize / 8+1;
//        }
//        else
//        {
//              m_dataBufferSize= m_dataBufferSize / 8;
//        }
//    }
//    else if(m_registerType == 2||m_registerType == 3)
//    {
//        m_dataBufferSize= (qint16)(m_endAddress - m_startAddress+1)*2;
//    }
}
...
bool CMDDataBlock::checkVarAddress(IMDRTDBVariable* nsVar,QString &error)
{
    ...
    QT_TRY
    {
        ...
        qint16 address =  0;
        int tempAddressFlag = verifyAddressFormat(strAddress,address,nTempAddressFormat);
        if(tempAddressFlag == ADDRESS_FORMAT_ERROR)
        {
            error = tr("变量地址格式错误!");
            return ret;
        }
