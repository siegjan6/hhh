...
class CMDDevice:public CBaseDevice
{
    ...
    Q_ENUMS(MDProtocolFormat_Pro)
    Q_PROPERTY(MDProtocolFormat_Pro ProtocolFormat READ protocolFormat_Pro WRITE setProtocolFormat_Pro)
    Q_PROPERTY(bool CheckSum READ checkSum_Pro WRITE setCheckSum_Pro)
    Q_PROPERTY(QString OverTimer READ overTimer_Pro WRITE setOverTimer_Pro)
    //*******************************************************************************//
public:
    CMDDevice();
    ~CMDDevice();
    ...
    enum class  MDProtocolFormat_Pro
    {
        Format1 = 0,
        Format4 = 1,
    };
...
public:
    ...
    //!协议格式
    MDProtocolFormat_Pro protocolFormat_Pro();
    void setProtocolFormat_Pro(MDProtocolFormat_Pro format);
    //!和校验
    bool checkSum_Pro();
    void setCheckSum_Pro(bool sum);
    //!通信超时时间
    QString overTimer_Pro();
    void setOverTimer_Pro(QString timer);
    //*******************************************************************//
private slots:
...
private:
    ...
    MDProtocolFormat_Pro m_protocolFormat_Pro;
    bool m_checkSum_Pro;
    QString m_overTimer_Pro;
    //******************************************************************//
public:
    ...
    /*!
      * \brief protocalFormat:
         *  协议格式获取.
      */
    qint16 protocalFormat();
    /*!
      * \brief setprotocalFormat:
         *  设置协议格式.
      */
    void setprotocalFormat(qint16 format);
    /*!
      * \brief checkSum:
         *  和校验标志位.
      */
    ...
    /*!
      * \brief setStation:
         *  设置通信超时时间.
      */
    void setComOverTimer(qint16 overtimer);
    /*!
      * \brief configDecice:
         *  配置device界面.
      */
    ...
    QString protocalFormatIndexToString(qint16 index);
    qint16 protocalFormatStringToIndex(QString str);
private:
    qint16 m_station;//!站号
    QString m_commParameter;//!通信参数
    CommunicationType m_commType;//!通信类型
    qint16 m_nProtocalFormat;//!协议格式
    bool m_bCheckSum;//!和校验标志位
    qint16 m_nComOverTimer;//!通信超时时间
public:
    /*!
     * \brief addVariable:
        * 添加变量.
